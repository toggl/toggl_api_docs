...
`POST https://api.track.toggl.com/api/v8/groups`
...
curl -v -u 1971800d4d82861d8f2c1651fea4d212:api_token \
	...
	-X POST https://api.track.toggl.com/api/v8/groups
...
## Update a group
`PUT https://api.track.toggl.com/api/v8/groups/{group_id}`
...
curl -v -u 1971800d4d82861d8f2c1651fea4d212:api_token \
	...
	-X PUT https://api.track.toggl.com/api/v8/groups/1239455
```
...
`DELETE https://api.track.toggl.com/api/v8/groups/{group_id}`

Example request
```shell
curl -v -u 1971800d4d82861d8f2c1651fea4d212:api_token \
	-X DELETE https://api.track.toggl.com/api/v8/groups/1239455
```
