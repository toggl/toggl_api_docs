...
`POST https://api.track.toggl.com/api/v8/workspaces/{workspace_id}/invite`
...
curl -v -u 1971800d4d82861d8f2c1651fea4d212:api_token \
	...
	-X POST https://api.track.toggl.com/api/v8/workspaces/777/invite
```
...
`PUT https://api.track.toggl.com/api/v8/workspace_users/{workspace_user_id}`
...
curl -v -u 1971800d4d82861d8f2c1651fea4d212:api_token \
	...
	-X PUT https://api.track.toggl.com/api/v8/workspace_users/19012628
```
...
`DELETE https://api.track.toggl.com/api/v8/workspace_users/{workspace_user_id}`

Example request
```shell
curl -v -u 1971800d4d82861d8f2c1651fea4d212:api_token \
	-X DELETE https://api.track.toggl.com/api/v8/workspace_users/19012628
```
...
`GET https://api.track.toggl.com/api/v8/workspaces/{workspace_id}/workspace_users`

Example request
```shell
curl -v -u 1971800d4d82861d8f2c1651fea4d212:api_token \
-X GET https://api.track.toggl.com/api/v8/workspaces/777/workspace_users
```
