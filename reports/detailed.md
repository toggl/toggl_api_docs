...
There is one additiona parameter in detaield reports. As the returned data is paginated you have to add the page parameter.
...
Example request
```shell
curl -v -u 1971800d4d82861d8f2c1651fea4d212:api_token -X GET "https://toggl.com/reports/api/v2/details?workspace_id=123&since=2013-05-19&until=2013-05-20"
```
