...
Example request
```shell
curl -v -u 1971800d4d82861d8f2c1651fea4d212:api_token -X GET "https://api.track.toggl.com/reports/api/v2/details?workspace_id=123&start=2013-05-19&end=2013-05-20&user_agent=api_test"
```
