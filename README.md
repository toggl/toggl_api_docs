 ...
 * [Right From Left](https://play.google.com/store/apps/details?id=com.rightfromleftsw.toggltoggles) is a small Android app that can create home screen widgets that can be used to quickly start and stop frequently used time entries.
